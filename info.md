...
1. Click install.
1. In the HA UI go to "Configuration" -> "Integrations" click "+" and search for "Dynamic Energy Cost".
...
[license]: https://github.com/bvweerd/dynamic_energy_cost/blob/main/LICENSE
